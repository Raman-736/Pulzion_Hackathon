...
var require_d3_cloud = __commonJS({
  "node_modules/d3-cloud/index.js"(exports, module) {
    ...
    function archimedeanSpiral(size) {
      ...
      return function(t4) {
        return [e2 * (t4 *= 0.1) * Math.cos(t4), t4 * Math.sin(t4)];
      };
    }
...
function data_default(value, key) {
  ...
  for (var m2 = groups.length, update = new Array(m2), enter = new Array(m2), exit = new Array(m2), j2 = 0; j2 < m2; ++j2) {
    var parent = parents[j2], group = groups[j2], groupLength = group.length, data = value.call(parent, parent && parent.__data__, j2, parents), dataLength = data.length, enterGroup = enter[j2] = new Array(dataLength), updateGroup = update[j2] = new Array(dataLength), exitGroup = exit[j2] = new Array(groupLength);
...
function onAdd(typename, value, capture) {
  ...
  return function(d2, i, group) {
    var on = this.__on, o2, listener = wrap(value, i, group);
    if (on)
...
function timerFlush() {
  ...
  var t4 = taskHead, e2;
  while (t4) {
    if ((e2 = clockNow - t4._time) >= 0)
      t4._call.call(null, e2);
    t4 = t4._next;
  }
  --frame;
}
...
define_default(Hcl, hcl2, extend(Color, {
  brighter: function(k2) {
...
define_default(Cubehelix, cubehelix2, extend(Color, {
  brighter: function(k2) {
    k2 = k2 == null ? brighter : Math.pow(brighter, k2);
...
var rgb_default = function rgbGamma(y) {
  ...
  function rgb4(start3, end2) {
    var r2 = color4((start3 = rgb2(start3)).r, (end2 = rgb2(end2)).r), g = color4(start3.g, end2.g), b = color4(start3.b, end2.b), opacity = nogamma(start3.opacity, end2.opacity);
    return function(t4) {
      start3.r = r2(t4);
      start3.g = g(t4);
      start3.b = b(t4);
...
function decompose_default(a, b, c3, d2, e2, f) {
...
function hsl3(hue4) {
  return function(start3, end2) {
    var h2 = hue4((start3 = hsl2(start3)).h, (end2 = hsl2(end2)).h), s = nogamma(start3.s, end2.s), l = nogamma(start3.l, end2.l), opacity = nogamma(start3.opacity, end2.opacity);
    return function(t4) {
      start3.h = h2(t4);
      start3.s = s(t4);
      start3.l = l(t4);
...
function hcl3(hue4) {
  return function(start3, end2) {
    var h2 = hue4((start3 = hcl2(start3)).h, (end2 = hcl2(end2)).h), c3 = nogamma(start3.c, end2.c), l = nogamma(start3.l, end2.l), opacity = nogamma(start3.opacity, end2.opacity);
    return function(t4) {
      start3.h = h2(t4);
      start3.c = c3(t4);
      start3.l = l(t4);
...
var hcl_default = hcl3(hue);
var hclLong = hcl3(nogamma);
...
function cubehelix3(hue4) {
  return function cubehelixGamma(y) {
    ...
    function cubehelix7(start3, end2) {
      var h2 = hue4((start3 = cubehelix2(start3)).h, (end2 = cubehelix2(end2)).h), s = nogamma(start3.s, end2.s), l = nogamma(start3.l, end2.l), opacity = nogamma(start3.opacity, end2.opacity);
      return function(t4) {
        start3.h = h2(t4);
        start3.s = s(t4);
...
var cubehelix_default = cubehelix3(hue);
var cubehelixLong = cubehelix3(nogamma);
...
function interpolate_default(a, b) {
  var c3;
  return (typeof b === "number" ? number_default : b instanceof color2 ? rgb_default : (c3 = color2(b)) ? (b = c3, rgb_default) : string_default)(a, b);
}
...
function hue2(a, b) {
  var d2 = b - a;
  return d2 ? linear3(a, d2 > 180 || d2 < -180 ? d2 - 360 * Math.round(d2 / 360) : d2) : constant_default3(isNaN(a) ? b : a);
}
function gamma2(y) {
...
function nogamma2(a, b) {
  var d2 = b - a;
  return d2 ? linear3(a, d2) : constant_default3(isNaN(a) ? b : a);
}
...
var rgb_default2 = function rgbGamma2(y) {
  var color4 = gamma2(y);
  function rgb4(start3, end2) {
    var r2 = color4((start3 = rgb(start3)).r, (end2 = rgb(end2)).r), g = color4(start3.g, end2.g), b = color4(start3.b, end2.b), opacity = nogamma2(start3.opacity, end2.opacity);
    return function(t4) {
      start3.r = r2(t4);
      start3.g = g(t4);
      start3.b = b(t4);
...
function value_default2(a, b) {
  var t4 = typeof b, c3;
  return b == null || t4 === "boolean" ? constant_default3(b) : (t4 === "number" ? number_default2 : t4 === "string" ? (c3 = color(b)) ? (b = c3, rgb_default2) : string_default2 : b instanceof color ? rgb_default2 : b instanceof Date ? date_default2 : isNumberArray2(b) ? numberArray_default2 : Array.isArray(b) ? genericArray2 : typeof b.valueOf !== "function" && typeof b.toString !== "function" || isNaN(b) ? object_default2 : number_default2)(a, b);
}
...
function decompose_default2(a, b, c3, d2, e2, f) {
  var scaleX, scaleY, skewX;
  if (scaleX = Math.sqrt(a * a + b * b))
    a /= scaleX, b /= scaleX;
  if (skewX = a * c3 + b * d2)
...
function interpolateTransform2(parse, pxComma, pxParen, degParen) {
  ...
  function rotate(a, b, s, q2) {
    if (a !== b) {
      if (a - b > 180)
        ...
        a += 360;
      q2.push({ i: s.push(pop(s) + "rotate(", null, degParen) - 2, x: number_default2(a, b) });
    } else if (b) {
      s.push(pop(s) + "rotate(" + b + degParen);
    }
  }
  function skewX(a, b, s, q2) {
    if (a !== b) {
      q2.push({ i: s.push(pop(s) + "skewX(", null, degParen) - 2, x: number_default2(a, b) });
    } else if (b) {
      s.push(pop(s) + "skewX(" + b + degParen);
    }
  }
...
function hsl4(hue4) {
  return function(start3, end2) {
    var h2 = hue4((start3 = hsl(start3)).h, (end2 = hsl(end2)).h), s = nogamma2(start3.s, end2.s), l = nogamma2(start3.l, end2.l), opacity = nogamma2(start3.opacity, end2.opacity);
    return function(t4) {
      start3.h = h2(t4);
      start3.s = s(t4);
      start3.l = l(t4);
...
function hcl4(hue4) {
  return function(start3, end2) {
    var h2 = hue4((start3 = hcl(start3)).h, (end2 = hcl(end2)).h), c3 = nogamma2(start3.c, end2.c), l = nogamma2(start3.l, end2.l), opacity = nogamma2(start3.opacity, end2.opacity);
    return function(t4) {
      start3.h = h2(t4);
      start3.c = c3(t4);
      start3.l = l(t4);
...
function cubehelix4(hue4) {
  return function cubehelixGamma(y) {
    y = +y;
    function cubehelix7(start3, end2) {
      var h2 = hue4((start3 = cubehelix(start3)).h, (end2 = cubehelix(end2)).h), s = nogamma2(start3.s, end2.s), l = nogamma2(start3.l, end2.l), opacity = nogamma2(start3.opacity, end2.opacity);
      return function(t4) {
        start3.h = h2(t4);
        start3.s = s(t4);
        start3.l = l(Math.pow(t4, y));
...
function transformer() {
  ...
  scale.invert = function(y) {
    return clamp(untransform((input || (input = piecewise4(range, domain.map(transform), number_default2)))(y)));
  };
  scale.domain = function(_) {
...
function loggish(transform) {
  ...
  scale.ticks = function(count) {
    ...
    if (r2 = v < u)
      i = u, u = v, v = i;
    var i = logs(u), j2 = logs(v), p, k2, t4, n2 = count == null ? 10 : +count, z2 = [];
    if (!(base % 1) && j2 - i < n2) {
...
define_default2(Lab2, lab5, extend2(Color2, {
  brighter: function(k2) {
...
define_default2(Hcl2, hcl5, extend2(Color2, {
  brighter: function(k2) {
...
function cubehelixConvert2(o2) {
  ...
  if (!(o2 instanceof Rgb2))
    o2 = rgbConvert2(o2);
  var r2 = o2.r / 255, g = o2.g / 255, b = o2.b / 255, l = (BC_DA2 * b + ED2 * r2 - EB2 * g) / (BC_DA2 + ED2 - EB2), bl = b - l, k2 = (E2 * (g - l) - C2 * bl) / D2, s = Math.sqrt(k2 * k2 + bl * bl) / (E2 * l * (1 - l)), h2 = s ? Math.atan2(k2, bl) * rad2deg2 - 120 : NaN;
...
define_default2(Cubehelix2, cubehelix5, extend2(Color2, {
  brighter: function(k2) {
    k2 = k2 == null ? brighter2 : Math.pow(brighter2, k2);
...
function hue3(a, b) {
  var d2 = b - a;
  return d2 ? linear5(a, d2 > 180 || d2 < -180 ? d2 - 360 * Math.round(d2 / 360) : d2) : constant_default4(isNaN(a) ? b : a);
}
function gamma3(y) {
  return (y = +y) === 1 ? nogamma3 : function(a, b) {
    return b - a ? exponential3(a, b, y) : constant_default4(isNaN(a) ? b : a);
  };
}
function nogamma3(a, b) {
  var d2 = b - a;
  return d2 ? linear5(a, d2) : constant_default4(isNaN(a) ? b : a);
}
...
function decompose_default3(a, b, c3, d2, e2, f) {
  var scaleX, scaleY, skewX;
  if (scaleX = Math.sqrt(a * a + b * b))
    a /= scaleX, b /= scaleX;
  if (skewX = a * c3 + b * d2)
...
function M() {
  return (M = Object.assign || function(t4) {
    for (var n2 = 1; n2 < arguments.length; n2++) {
      var r2 = arguments[n2];
      for (var e2 in r2)
        Object.prototype.hasOwnProperty.call(r2, e2) && (t4[e2] = r2[e2]);
    }
    return t4;
...
function A3(t4, n2, r2, e2) {
  if (!n2.sprite) {
    var o2 = t4.context, a = t4.ratio;
    o2.clearRect(0, 0, 2048 / a, 2048 / a);
    var i = 0, u = 0, f = 0, l = r2.length;
    for (--e2; ++e2 < l; ) {
      n2 = r2[e2], o2.save(), o2.font = n2.style + " " + n2.weight + " " + ~~((n2.size + 1) / a) + "px " + n2.font;
    ...
    for (var v = o2.getImageData(0, 0, 2048 / a, 2048 / a).data, g = []; --e2 >= 0; )
      if ((n2 = r2[e2]).hasText) {
...
function I(t4, n2, r2) {
  for (var e2, o2 = t4.sprite, a = t4.width >> 5, i = t4.x - (a << 4), u = 127 & i, f = 32 - u, l = t4.y1 - t4.y0, s = (t4.y + t4.y0) * (r2 >>= 5) + (i >> 5), c3 = 0; c3 < l; c3++) {
    e2 = 0;
    for (var h2 = 0; h2 <= a; h2++)
      if ((e2 << f | (h2 < a ? (e2 = o2[c3 * a + h2]) >>> u : 0)) & n2[s + h2])
        return true;
    s += r2;
  }
  return false;
...
function q(t4, n2) {
  var r2 = t4[0], e2 = t4[1];
  n2.x + n2.x0 < r2.x && (r2.x = n2.x + n2.x0), n2.y + n2.y0 < r2.y && (r2.y = n2.y + n2.y0), n2.x + n2.x1 > e2.x && (e2.x = n2.x + n2.x1), n2.y + n2.y1 > e2.y && (e2.y = n2.y + n2.y1);
}
function E3(t4) {
  var n2 = t4[0] / t4[1];
  return function(t5) {
...
function U(t4) {
  ...
  }).slice(0, e2), Y = (0, import_seedrandom.default)(f ? G2 || "deterministic" : null);
  (n2 = x ? function() {
    var t5 = [256, 256], n3 = k, r3 = W, e3 = O, o3 = S, a2 = S, i = T, u2 = j, f2 = E3, l = [], s = Infinity, c3 = dispatch_default2("word", "end"), h2 = Math.random, d2 = {}, m2 = C3, y = false;
    function x2(n4, r4, e4) {
      for (var o4, a3, i2, u3, l2, s2 = r4.x, c4 = r4.y, d3 = Math.sqrt(t5[0] * t5[0] + t5[1] * t5[1]), m3 = f2(t5), y2 = h2() < 0.5 ? 1 : -1, p = -y2; (o4 = m3(p += y2)) && (a3 = ~~o4[0], i2 = ~~o4[1], !(Math.min(Math.abs(a3), Math.abs(i2)) >= d3)); )
        if (r4.x = s2 + a3, r4.y = c4 + i2, !(r4.x + r4.x0 < 0 || r4.y + r4.y0 < 0 || r4.x + r4.x1 > t5[0] || r4.y + r4.y1 > t5[1] || e4 && I(r4, n4, t5[0]) || e4 && !((u3 = r4).x + u3.x1 > (l2 = e4)[0].x && u3.x + u3.x0 < l2[1].x && u3.y + u3.y1 > l2[0].y && u3.y + u3.y0 < l2[1].y))) {
    ...
    return d2.canvas = function(t6) {
      ...
      var f3 = function(t6) {
        ...
        return t6.text = n3.call(this, t6, f4), t6.font = r3.call(this, t6, f4), t6.style = o3.call(this, t6, f4), t6.weight = a2.call(this, t6, f4), t6.rotate = i.call(this, t6, f4), t6.size = ~~e3.call(this, t6, f4), t6.padding = u2.call(this, t6, f4), t6;
      }).sort(function(t6, n4) {
        return n4.size - t6.size;
      });
      return setTimeout(function() {
        return function n4(r4) {
          var e4 = 50 * r4, o4 = Math.min(50 * (r4 + 1), l.length);
          !function(n5, r5) {
            for (var e5 = n5; e5 < r5; e5 += 1) {
              var o5 = g[e5];
              o5.x = t5[0] * (h2() + 0.5) >> 1, o5.y = t5[1] * (h2() + 0.5) >> 1, A3(f3, o5, g, e5), o5.hasText && x2(s2, o5, p) && (v.push(o5), c3.call("word", d2, o5), p ? q(p, o5) : p = [{ x: o5.x + o5.x0, y: o5.y + o5.y0 }, { x: o5.x + o5.x1, y: o5.y + o5.y1 }], o5.x -= t5[0] >> 1, o5.y -= t5[1] >> 1);
            }
          }(e4, o4), y || (o4 < l.length ? setTimeout(function() {
            return n4(r4 + 1);
      ...
      return arguments.length ? (e3 = D3(t6), d2) : e3;
  ...
  }).spiral(Q).random(Y).text(N).font(w).fontStyle(z2).fontWeight(H2), function t5(e3, u2) {
    void 0 === u2 && (u2 = 1), x && n2.revive(), n2.fontSize(function(t6) {
      return function(t7, n3, r3) {
        var e4, o3 = min(t7, function(t8) {
        ...
        return e4().domain([o3, a2]).range(n3);
      }(X, e3, V)(t6.value);
    }).on("end", function(n3) {
      if (X.length !== n3.length && u2 <= 10) {
        ...
        var f2 = Math.max(0.95 * e3[0], 1);
        t5([f2, Math.max(0.95 * e3[1], f2)], u2 + 1);
      } else
        !function(t6) {
          var n4, r3 = t6.callbacks, e4 = t6.options, o3 = t6.random, a2 = t6.words, u3 = r3.getWordColor, f3 = r3.getWordTooltip, l = r3.onWordClick, s = r3.onWordMouseOver, c3 = r3.onWordMouseOut, h2 = e4.colors, d2 = e4.enableTooltip, m2 = e4.fontStyle, p = e4.fontWeight, x2 = e4.textAttributes, v = e4.tooltipOptions, g = e4.fontFamily, b = e4.transitionDuration;
          function w2(t7) {
...
function G(i) {
  var f = i.callbacks, l = i.maxWords, s = void 0 === l ? 100 : l, c3 = i.minSize, h2 = i.options, d2 = i.size, m2 = i.words, y = function(t4, n2) {
    if (null == t4)
      return {};
    var r2, e2, o2 = {}, a = Object.keys(t4);
    for (e2 = 0; e2 < a.length; e2++)
      n2.indexOf(r2 = a[e2]) >= 0 || (o2[r2] = t4[r2]);
    return o2;
    ...
    return (0, import_react.useEffect)(function() {
      var r2 = f2.current, e2 = select_default2(r2).append("svg").style("display", "block");
      "object" == typeof i2 && Object.keys(i2).forEach(function(t5) {
        e2 = e2.attr(t5, i2[t5]);
      });
      var o2 = e2.append("g");
      function l3(t5, n3) {
        e2.attr("height", n3).attr("width", t5), o2.attr("transform", "translate(" + t5 / 2 + ", " + n3 / 2 + ")"), c4([t5, n3]);
      }
      m3(o2);
      var s3 = 0, h4 = 0;
